...
{
	$main_content .= '<B>'.htmlspecialchars(SERVER_NAME).' Rules</B><BR><TEXTAREA ROWS="25" WRAP="physical" COLS="80" READONLY="true">';
}
$main_content .= SERVER_NAME . " is an online role-playing game in which thousands of players from all over the world meet everyday. In order to ensure that the game is fun for everyone, ".SERVER_NAME." staff expects all players to behave in a reasonable and respectful manner.

".SERVER_NAME." staff reserves the right to stop destructive behaviour in the game or in the official website. Such behaviour includes, but is not limited to, the following offences:
...
d) Unsuitable Name
Names that express religious or political views or generally do not fit into ".SERVER_NAME."'s medieval fantasy setting.
e) Name Supporting Rule Violation
Names that support, incite, announce or imply a violation of the ".SERVER_NAME." Rules.
...
Statements that support, incite, announce or imply a violation of the ".SERVER_NAME." Rules.
...
4. ".SERVER_NAME." staff
a) Pretending to be ".SERVER_NAME." staff
Pretending to be a representative of ".SERVER_NAME." staff or to have their legitimation or powers.
b) Slandering or Agitating against ".SERVER_NAME." staff
Publishing clearly wrong information about or calling a boycott against ".SERVER_NAME.".
c) False Information to ".SERVER_NAME." staff
Intentionally giving wrong or misleading information to ".SERVER_NAME." staff in reports about rule violations, complaints, bug reports or support requests.
...
c) Attacking ".SERVER_NAME." Server
Attacking, disrupting or damaging the operation of ".SERVER_NAME." server.
d) Violating Law or Regulations
Violating any applicable law, the ".SERVER_NAME." Service Agreement or rights of third parties.
 

Violating or attempting to violate the ".SERVER_NAME." Rules may lead to a temporary suspension of characters and accounts. In severe cases the removal or modification of character skills, attributes and belongings, as well as the permanent removal of characters and accounts without any compensation may be considered. The sanction is based on the seriousness of the rule violation and the previous record of the player. It is determined at the sole discretion of ".SERVER_NAME." staff and can be imposed without any previous warning.

These rules may be changed at any time. All changes will be announced on the ".SERVER_NAME." website.";
if($subtopic == "tibiarules")
{
