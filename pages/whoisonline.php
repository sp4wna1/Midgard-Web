...
$vocations_online_count = array(0, 0, 0, 0, 0, 0, 0); // change it if you got more then 5 vocations
$players_rows = '';
    ...
    $main_content .= '<table width="200" cellspacing="1" cellpadding="0" border="0" align="center">
		<tbody>
			...
			<tr>
				...
				<td style="text-align: center;">' . ($vocations_online_count[1] + $vocations_online_count[5]) . '</td>
				<td style="text-align: center;">' . ($vocations_online_count[2] + $vocations_online_count[6]) . '</td>
				<td style="text-align: center;">' . ($vocations_online_count[3] + $vocations_online_count[7]) . '</td>
				<td style="text-align: center;">' . ($vocations_online_count[4] + $vocations_online_count[8]) . '</td>
			</tr>
		</tbody>
	</table>
