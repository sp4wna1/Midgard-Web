...
/*
  ...
  <div class="Odd">
    ...
    $last_featuredArticle = $SQL->query('SELECT ' . $SQL->tableName('players') . '.' . $SQL->fieldName('name') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_text') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_topic') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_smile') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('id') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('replies') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_date') . ' FROM ' . $SQL->tableName('players') . ', ' . $SQL->tableName('forum') . ' WHERE ' . $SQL->tableName('players') . '.' . $SQL->fieldName('id') . ' = ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('author_guid') . ' AND ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('section') . ' = 1 AND ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('first_post') . ' = ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('id') . ' AND ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_topic') . '=\'Featured Article\'' . ' ORDER BY ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('last_post') . ' DESC LIMIT 1')->fetchAll();
  ...
  $featuredArticle = '<div id="featuredarticle" class="Box">
    ...
    $last_threads = $SQL->query('SELECT ' . $SQL->tableName('players') . '.' . $SQL->fieldName('name') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_text') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_topic') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_smile') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('id') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('replies') . ', ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_date') . ' FROM ' . $SQL->tableName('players') . ', ' . $SQL->tableName('forum') . ' WHERE ' . $SQL->tableName('players') . '.' . $SQL->fieldName('id') . ' = ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('author_guid') . ' AND ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_topic') . '!=\'News Ticker\'' . ' AND ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('post_topic') . '!=\'Featured Article\'' . ' AND ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('section') . ' = 1 AND ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('first_post') . ' = ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('id') . ' ORDER BY ' . $SQL->tableName('forum') . '.' . $SQL->fieldName('last_post') . ' DESC LIMIT ' . $config['site']['news_limit'])->fetchAll();
